<?php
  ...
  $letra  = strtoupper(mb_substr($old['nombre'] ?? '', 0, 1) ?: '?');
  unset($_SESSION['old_input']);
?>

<style>
/* ── Wrapper ── */
.uf-wrap { max-width: 780px; margin: 0 auto; }
...
.uf-hero-info h3 { margin: 0 0 4px; font-size: 20px; font-weight: 700; }
.uf-hero-info p  { margin: 0; font-size: 13px; opacity: .75; }
.uf-hero-back {
    margin-left: auto;
...
.uf-hero-back:hover { background: rgba(255,255,255,.28); }
...
.uf-hint { font-size: 11px; color: #9ca3af; margin-top: 5px; }
...
.uf-toggle-row input[type="checkbox"] {
    width: 18px; height: 18px; accent-color: #7b1b3b;
    cursor: pointer; flex-shrink: 0;
}
.uf-toggle-row span { font-size: 14px; font-weight: 600; color: #374151; user-select: none; }

/* ── Footer ── */
.uf-footer {
    display: flex; justify-content: flex-end; gap: 12px;
    padding-top: 20px; border-top: 1.5px solid #f0f0f5; margin-top: 4px;
}
.uf-btn-cancel {
    padding: 10px 20px; border-radius: 10px; background: #f3f4f6;
...
<div class="uf-wrap">
  <!-- Cabecera -->
  <div class="uf-hero">
    <div class="uf-hero-avatar" id="uf-avatar-preview"><?= $letra ?></div>
    <div class="uf-hero-info">
      <h3>Nuevo usuario</h3>
      <p>Completa el formulario para agregar un nuevo usuario al sistema</p>
    </div>
    <a class="uf-hero-back" href="<?= BASE_URI ?>/index.php?controller=users&action=index">← Volver</a>
  </div>
      ...
      <div class="uf-section">
        ...
        <div class="uf-grid">
          <div class="uf-field">
            ...
            <input type="text" name="nombre" required id="uf-nombre-input"
      ...
      <div class="uf-section">
        ...
        <div class="uf-grid">
          <div class="uf-field">
            ...
            <p class="uf-hint">Mínimo 8 caracteres.</p>
          </div>
          <div class="uf-field">
        ...
        <div class="uf-grid">
          ...
          <div class="uf-field" style="display:flex;flex-direction:column;justify-content:flex-end">
            ...
            <label class="uf-toggle-row" for="chk_activo">
              <input type="checkbox" name="activo" id="chk_activo" checked>
...
(function(){
  ...
  input.addEventListener('input', function(){
    avatar.textContent = (this.value.trim()[0] || '?').toUpperCase();
  });
})();
</script>
